...
const Layout = ({ xl, ...props }) => {
  ...
  return (
    ...
    >
      ...
      >
        <Avatar />
        <a href="https://twitter.com/zenithsilvarex" title="Twitter">
          <Icon glyph="twitter" size={36} />
        </a>
        <a href="https://github.com/goldenglorys/notebook" title="GitHub">
          <Icon glyph="github" size={36} />
        </a>
        <a href="mailto:olusolagloryolamide@gmail.com" title="Email">
